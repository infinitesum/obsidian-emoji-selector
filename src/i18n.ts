...
const EN_STRINGS: I18nStrings = {
    ...
    owoJsonUrlsDesc: 'OWO emoji packs are supported; separate multiple entries with commas. Find more emoji packs at: https://emoticons.hzchu.top/ Files will be cached until you click "Update". ',
...
const ZH_CN_STRINGS: I18nStrings = {
    ...
    owoJsonUrlsDesc: '支持 OWO 格式的表情包，多个地址用英文逗号隔开。可在 https://emoticons.hzchu.top/ 找到更多表情包。文件会保存在本地，直到你点"更新"才会重新加载。',
